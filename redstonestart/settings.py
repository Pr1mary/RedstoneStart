"""
Django settings for redstonestart project.
...
# Email definition
DEFAULT_FROM_EMAIL=os.getenv("EMAIL_FROM", "webmaster@example.com")
...
ROOT_URLCONF = 'redstonestart.urls'
...
ASGI_APPLICATION = 'redstonestart.asgi.application'
WSGI_APPLICATION = 'redstonestart.wsgi.application'
